...
public:
  ...
  virtual const target::Cpu& cpu_get () const override { return cpu_; }
  virtual target::Cpu& cpu_get () override { return cpu_; }

  virtual const target::Assembly& assembly_get () const override
  { return assembly_; }
  virtual target::Assembly& assembly_get () override { return assembly_; }

  virtual const target::Codegen& codegen_get () const override
  { return codegen_; }
  virtual target::Codegen& codegen_get () override { return codegen_; }

protected:
  MyCpu cpu_;
  target::mips::Codegen codegen_;
...
example_1()
{
  ...
  assem::Instrs instrs = {
    ...
    // L1: b := a + 1
    new assem::Label("L1:", l1),
    new assem::Oper("b := a + 1", Ts(a), Ts(b)),
  ...
  std::cout << allocator.allocation_get() << std::endl;
}
...
example_2()
{
  ...
  assem::Instrs instrs = {
    ...
    // r1 := d
    new assem::Label("end:", end),
    new assem::Move("r1 := d", d, r1),
