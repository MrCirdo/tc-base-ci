 ...
 ** formal FOO, it needs to know wether it escapes or not.  This
...
#ifndef ESCAPES_ESCAPES_VISITOR_HH
# define ESCAPES_ESCAPES_VISITOR_HH
...
namespace escapes
{
   ...
   ** depth): a simple map suffice, since scoping issues were handled
   ** by the bind::Binder.
   **
...
#endif // !ESCAPES_ESCAPES_VISITOR_HH
