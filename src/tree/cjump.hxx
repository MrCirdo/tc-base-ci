...
#ifndef TREE_CJUMP_HXX
# define TREE_CJUMP_HXX
...
namespace tree
{
    ...
    , relop_(relop)
  {
    ...
    child_push_back(iftrue);
    child_push_back(iffalse);
  }
  ...
  {
    children_.pop_back();
    children_.push_back(new Name(false_label));
  }
  ...
  Cjump::flip()
  {
    ...
    children_.pop_back();
    children_.pop_back();
    children_.push_back(iffalse);
    children_.push_back(iftrue);
    switch (relop_)
      {
