...
namespace tree
{
  inline void Tree::child_emplace_back(const rTree& tree)
  {
  ...
  inline tree_list_type& Tree::children_get() { return children_; }

  inline const tree_list_type& Tree::children_get() const { return children_; }

  inline void Tree::child_set(rTree& dst, const rTree& src)
  {
    dst = src;
    if (src)
      src->parent_set(this);
  ...
  inline rTree& Tree::child_get(int nth)
  {
  ...
  inline rTree Tree::child_get(int nth) const
  {
  ...
  inline rTree& Tree::left_get() { return child_get(0); }

  inline rTree& Tree::right_get() { return child_get(1); }
