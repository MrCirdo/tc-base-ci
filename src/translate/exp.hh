 ...
 ** tree::expression) as a statement when needed, or as a condional
 ** etc.
 **
 ...
 **   be used as a statement: it is abornal (hence abort ()) to use it
 ...
 ** NAMEs which correspond to the THEN and the ELSE.  So naturally un_cx
 ...
 ** would try to branch to `4' at the end of the `2' is 2 appears to be
 ...
 ** the then and else parts.  This will typically give mcuh better code
 ** for things like
 **
 ...
 ** An extra class is needed, named, Ix.
 **
 **
...
#ifndef TRANSLATE_EXP_HH
# define TRANSLATE_EXP_HH
...
namespace translate
{
  ...
  public:
    ...
    virtual tree::rStm un_cx(const temp::Label& t,
  ...
  public:
    ...
    virtual tree::rExp un_ex() override;
    virtual tree::rStm un_nx() override;
    virtual tree::rStm un_cx(const temp::Label&,
                            const temp::Label&) override;
  ...
  public:
    ...
    virtual tree::rExp un_ex() override;
    virtual tree::rStm un_nx() override;
    virtual tree::rStm un_cx(const temp::Label& t_outer,
