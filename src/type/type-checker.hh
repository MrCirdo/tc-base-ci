...
namespace type
{
  ...
  class TypeChecker : public ast::DefaultVisitor, public ast::NonObjectVisitor
  {
  public:
  ...
  protected:
    ...
    ///
    /// \param loc   the node whose location is used in the error message
    ///              and whose type is set to integer as an attempt to
    ///              recover.
    /// \param msg   the error message
    /// \param exp   the culprit.  It must support << output
