...
namespace type
{
  ...
  inline const Attribute* Class::attr_find(const misc::symbol& key) const
  {
  ...
  inline const Method* Class::meth_find(const misc::symbol& key) const
  {
    for (const Class* cur = this; cur; cur = cur->super_get())
      {
  ...
  inline const Attribute* Class::owned_attr_find(const misc::symbol& key) const
  {
  ...
  inline const Method* Class::owned_meth_find(const misc::symbol& key) const
  {
