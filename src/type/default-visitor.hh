...
namespace type
{
  ...
  public:
     ...
     ** \{ */
    virtual void operator()(const_t<Nil>& e) override;
    virtual void operator()(const_t<Void>& e) override;
    virtual void operator()(const_t<Int>& e) override;
    virtual void operator()(const_t<String>& e) override;
    /** \} */


    /** \name Visit composed types.
     ** \{ */
    virtual void operator()(const_t<Named>& e) override;
    virtual void operator()(const_t<Array>& e) override;
    virtual void operator()(const_t<Record>& e) override;
    virtual void operator()(const_t<Class>& e) override;
    virtual void operator()(const_t<Function>& e) override;
    virtual void operator()(const_t<Method>& e) override;
    /** \} */
  };
