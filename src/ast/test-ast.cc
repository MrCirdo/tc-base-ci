...
int main()
{
  ...
  std::cout << "Second test...\n";
  {
    ...
    FunctionDec* fundec =
      new FunctionDec(loc, "f", new VarDecs(loc), new NameTy(loc, "int"),
    ...
    Exp* exp = new LetExp(loc, decs, new CallExp(loc, "f", new exps_type()));
    std::cout << *exp << '\n';
    delete exp;
  }
  ...
  std::cout << "Third test...\n";
  {
    ...
    auto formals =
      new VarDecs::Ds{new VarDec(loc, "a", new NameTy(loc, "int"), nullptr),
                      new VarDec(loc, "b", new NameTy(loc, "int"), nullptr)};
    // Declaration of the function:
    // `function f (a : int, b : int) : int = g (a)'.
    FunctionDec* fundec =
      new FunctionDec(loc, "f", new VarDecs(loc, formals),
