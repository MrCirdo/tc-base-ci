...
namespace ast
{
  ...
  */
  ...
  public:
    ...
    /// \{
    virtual void operator()(const_t<ClassTy>& e) override;

    virtual void operator()(const_t<MethodDecs>& e) override;
    virtual void operator()(const_t<MethodDec>& e) override;

    virtual void operator()(const_t<MethodCallExp>& e) override;
    virtual void operator()(const_t<ObjectExp>& e) override;
    /// \}
  };
