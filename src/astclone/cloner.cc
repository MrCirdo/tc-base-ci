...
namespace astclone
{
  ...
  void Cloner::operator()(const ast::CastVar& e)
  {
    const Location& location = e.location_get();
  ...
  void Cloner::operator()(const ast::DecsList& e)
  {
    const Location& location = e.location_get();
  ...
  void Cloner::operator()(const ast::FunctionDecs& e)
  {
    decs_visit<ast::FunctionDecs>(e);
  }

  void Cloner::operator()(const ast::MethodDecs& e)
  {
  // FIXME: Some code was deleted here.
  }

  void Cloner::operator()(const ast::TypeDecs& e)
  {
  // FIXME: Some code was deleted here.
  }

  void Cloner::operator()(const ast::VarDecs& e)
  {
  // FIXME: Some code was deleted here.
  }
