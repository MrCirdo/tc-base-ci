...
namespace temp
{
  template <typename Tag_> struct temp_traits;

  template <> struct temp_traits<misc::symbol>
  {
    static const std::string prefix;
    static const int rank;
  };

  template <> struct temp_traits<unsigned>
  {
    static const std::string prefix;
    static const int rank;
  };
  ...
  MAYBE_EXTERN template std::ostream&
...
namespace misc
{
  ...
  MAYBE_EXTERN template std::ostream&
  operator<<(std::ostream& ostr, const map<temp::Temp, temp::Temp>& m);

  MAYBE_EXTERN template class vector<temp::Temp>;
  MAYBE_EXTERN template vector<temp::Temp>::vector(
    misc::set<temp::Temp>::const_iterator b,
    misc::set<temp::Temp>::const_iterator e);
  MAYBE_EXTERN template vector<temp::Temp>::vector(
    vector<temp::Temp>::const_iterator b,
    vector<temp::Temp>::const_iterator e);
  MAYBE_EXTERN template vector<temp::Temp>::vector(
    const misc::set<temp::Temp>& s);
