...
typedef temp_list_type TempList;
typedef label_list_type LabelList;
...
main()
{
  ...
  std::cout << "Testing TempMaps" << std::endl;
  TempMap map1;
  TempMap map2;
  TempMap *clone;
  ...
  std::cout << "Testing TempSets" << std::endl;

  std::list<Temp> list1 = { "foo", "bar" };
