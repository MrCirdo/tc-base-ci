...
namespace temp
{
  ...
  template <template <typename Tag_> class Traits_>
  std::ostream& operator<<(std::ostream& ostr, const Identifier<Traits_>& obj)
  {
    typename Identifier<Traits_>::map_type* m = Identifier<Traits_>::map(ostr);
    if (m)
  ...
  template <template <typename Tag_> class Traits_>
  std::ostream& Identifier<Traits_>::dump(std::ostream& ostr) const
  {
  // FIXME: Some code was deleted here.
  }

  template <template <typename Tag_> class Traits_>
  std::string Identifier<Traits_>::string_get() const
  {
  // FIXME: Some code was deleted here.
  }
  ...
  template <template <typename Tag_> class Traits_>
  const std::string& Identifier<Traits_>::prefix_get() const
  {
  // FIXME: Some code was deleted here.
  }

  template <template <typename Tag_> class Traits_>
  int Identifier<Traits_>::rank_get() const
  {
  // FIXME: Some code was deleted here.
  }
  ...
  template <template <typename Tag_> class Traits_>
  bool Identifier<Traits_>::operator==(const Identifier<Traits_>& rhs) const
  {
  // FIXME: Some code was deleted here.
  }
