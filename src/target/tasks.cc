...
namespace target
{
  ...
  namespace tasks
  {
    ...
    */
    ...
    target_ia32()
    {
      target_set(new ::target::ia32::Target(rule_trace_p));
    }
    ...
    target_arm()
    {
      target_set(new ::target::arm::Target(rule_trace_p));
    }
    ...
    inst_compute()
    {
      ...
      fragments.reset(lir_to_assem(*translate::tasks::fragments,
                                   *target));
    }
    ...
    runtime_display()
    {
      runtime_dump(*target, gc_p, std::cout);
    }
