...
#ifndef TARGET_IA32_GAS_ASSEMBLY_HH
# define TARGET_IA32_GAS_ASSEMBLY_HH
...
namespace target
{
  ...
  namespace ia32
  {
    ...
    public:
       ...
       ** \{ */
    public:
      /// Build the lovely, so famous, so CISC, push instruction.
...
#endif // !TARGET_IA32_GAS_ASSEMBLY_HH
