...
namespace target
{
  namespace ia32
  {
    ...
    void
    GasCodegen::cpu_set(const target::ia32::Cpu& cpu)
    {
      cpu_ = &cpu;
    }
    ...
    void
    GasCodegen::assembly_set(GasAssembly& assembly)
    {
      assembly_ = &assembly;
    }

    GasAssembly&
    GasCodegen::assembly_get()
    {
      assertion(assembly_);
      return *assembly_;
    }
    ...
    void
    GasCodegen::codegen(const tree::rStm& root)
    {
      assertion(cpu_);
    ...
    void
    GasCodegen::reduce(rTree& tree, int goal)
    {
    ...
    assem::Instrs
    GasCodegen::store_inframe(const frame::Access* access,
    ...
    assem::Instrs
    GasCodegen::load_inframe(const frame::Access* access,
                          const temp::Temp& word,
                          const temp::Temp& addr) const
    {
      auto acc_frame = dynamic_cast<const frame::In_Frame&>(*access);
    ...
    void
    GasCodegen::free_callee_save(assem::ProcFrag& frag)
    {
    ...
    void
    GasCodegen::view_shift(assem::ProcFrag& frag)
    {
    ...
    void
    GasCodegen::fragment_entry_exit_build(assem::ProcFrag& frag)
    {
    ...
    void
    GasCodegen::frame_build(assem::ProcFrag& frag) const
    {
    ...
    void
    GasCodegen::rewrite_program(assem::ProcFrag& frag,
