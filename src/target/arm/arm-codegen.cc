...
#line 4 "target/arm/call.brg"
  ...
  EMIT(ARM_ASSEMBLY.call_build(function->label_get(),
                               MCPU.argument_regs(),
                               res));
...
mono_burg_emit_11 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) c;
  {
#line 34 "target/arm/mem.brg"

  EMIT(ARM_ASSEMBLY.load_build(c.cast<Const>()->value_get(), tree->asm_get()));
...
mono_burg_emit_12 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) e;
  {
#line 39 "target/arm/mem.brg"

  temp::Temp res;

  EMIT(ARM_ASSEMBLY.load_build(e->asm_get(), res));
  tree->asm_set(res);
...
mono_burg_emit_16 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) e2;
  {
#line 5 "target/arm/move.brg"

  temp::Temp rval;

  auto exp = e2.cast<Exp>();
  assertion(exp);
  EMIT(ARM_ASSEMBLY.load_build(exp->asm_get(), rval));

  exp = e1.cast<Exp>();
  assertion(exp);
  EMIT(ARM_ASSEMBLY.store_build(rval, exp->asm_get()));
...
mono_burg_emit_17 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  {
  {
#line 5 "target/arm/move_store.brg"
  ...
  if(binop->oper_get() == Binop::Oper::sub)
    sign = -1;
  EMIT(ARM_ASSEMBLY.store_build(tree->right_get()->asm_get(),
                                binop_right->asm_get(),
...
mono_burg_emit_19 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) e;
  {
#line 29 "target/arm/move_store.brg"

  EMIT(ARM_ASSEMBLY.store_build(e->asm_get(), b->asm_get()));
...
mono_burg_emit_20 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) binop_right;
  {
#line 4 "target/arm/move_load.brg"
  ...
  if (binop->oper_get() == Binop::Oper::sub)
    sign = -1;
  EMIT(ARM_ASSEMBLY.load_build(binop_right->asm_get(),
                               sign * const_left->value_get(),
...
mono_burg_emit_21 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) binop_right;
  {
#line 24 "target/arm/move_load.brg"
  ...
  if (binop->oper_get() == Binop::Oper::sub)
    sign = -1;
  EMIT(ARM_ASSEMBLY.load_build(binop_left->asm_get(),
...
mono_burg_emit_22 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) b;
  {
#line 44 "target/arm/move_load.brg"

  EMIT(ARM_ASSEMBLY.load_build(b->asm_get(), e->asm_get()));
...
mono_burg_emit_24 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) e2;
  {
#line 28 "target/arm/move.brg"

  EMIT(ARM_ASSEMBLY.store_build(e2->asm_get(), e1->asm_get()));
...
mono_burg_emit_25 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) src;
  {
#line 33 "target/arm/move.brg"

  EMIT(ARM_ASSEMBLY.move_build(src->asm_get(), dst->asm_get()));
...
mono_burg_emit_26 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) src;
  {
#line 38 "target/arm/move.brg"

  EMIT(ARM_ASSEMBLY.move_build(src.cast<Const>()->value_get(), dst->asm_get()));
...
mono_burg_emit_27 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) c;
  {
#line 43 "target/arm/move.brg"

  EMIT(ARM_ASSEMBLY.load_build(c.cast<Const>()->value_get(), dst->asm_get()));
...
mono_burg_emit_28 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) e;
  {
#line 48 "target/arm/move.brg"

  EMIT(ARM_ASSEMBLY.load_build(e->asm_get(), dst->asm_get()));
...
mono_burg_emit_31 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  (void) c;
  {
#line 4 "target/arm/cjump.brg"

  auto cjump = tree.cast<Cjump>();
  auto cst = c.cast<Const>();

  EMIT(ARM_ASSEMBLY.cjump_build(cjump->relop_get(),
                                e->asm_get(),
                                cst->value_get(),
...
mono_burg_emit_38 (MBTREE_TYPE &tree, MBCGEN_TYPE *s)
{
  ...
  {
  {
#line 26 "target/arm/stm.brg"

  auto lab = tree.cast<Label>();
  EMIT(ARM_ASSEMBLY.label_build(lab->label_get()));
...
#line 31 "target/arm/tree.brg"

#line 1 "target/arm/epilogue.cc"
namespace target::arm
{
  ...
  void ArmCodegen::cpu_set(const target::arm::Cpu& cpu) { cpu_ = &cpu; }

  inline const target::arm::Cpu* ArmCodegen::cpu_get() const { return cpu_; }

  void ArmCodegen::assembly_set(ArmAssembly& assembly)
  {
    assembly_ = &assembly;
  }

  ArmAssembly& ArmCodegen::assembly_get()
  {
    assertion(assembly_);
    return *assembly_;
  }

  void ArmCodegen::codegen(const tree::rStm& root)
  {
    assertion(cpu_);
  ...
  void ArmCodegen::reduce(rTree& tree, int goal)
  {
  ...
  assem::Instrs ArmCodegen::store_inframe(const frame::Access* access,
  ...
  assem::Instrs ArmCodegen::load_inframe(const frame::Access* access,
                                         const temp::Temp& word,
                                         const temp::Temp& addr) const
  {
    auto acc_frame = dynamic_cast<const frame::InFrame&>(*access);
  ...
  void ArmCodegen::free_callee_save(assem::ProcFrag& frag)
  {
  ...
  void ArmCodegen::view_shift(assem::ProcFrag& frag)
  {
    ...
    for (size_t slot = 3 * cpu_->word_size_get(); formal_iter != formals.end();
         ++formal_iter)
      {
        // A formal is either a InRegister (data is in a register) or
        // a InFrame (data is frame).
  ...
  void ArmCodegen::fragment_entry_exit_build(assem::ProcFrag& frag)
  {
  ...
  void ArmCodegen::frame_build(assem::ProcFrag& frag) const
  {
    assem::Instrs& ins = frag.instrs_get();
    ...
    frame_allocation_slot = std::next(misc::position_append_and_move(
      ...
      assembly_->push_build(cpu_->fp_reg(), cpu_->lr_reg())));
    ...
    frame_deallocation_slot = std::next(misc::position_append_and_move(
      ...
      assembly_->binop_build(Binop::Oper::add, cpu_->sp_reg(),
                             frag.frame_get().get_current_frame_size(),
                             cpu_->sp_reg())));
  ...
  void ArmCodegen::rewrite_program(assem::ProcFrag& frag,
