#ifndef TARGET_ARM_CODEGEN
# define TARGET_ARM_CODEGEN
...
namespace target
{
  namespace arm
  {
    ...
    public:
      ...
      /// Destroy a ArmCodegen.
      virtual ~ArmCodegen() = default;

    public:
      /// Define the targeted ArmCpu.
      void cpu_set(const target::arm::Cpu& cpu);
      /// Access concrete CPU.
      const target::arm::Cpu* cpu_get();
