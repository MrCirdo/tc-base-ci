...
#ifndef CALLGRAPH_FUNDEC_GRAPH_HXX
# define CALLGRAPH_FUNDEC_GRAPH_HXX
...
namespace callgraph
{
  ...
  inline void
  FundecGraph::fundec_link(ast::FunctionDec* fu,
                           ast::FunctionDec* fv)
  {
...
#endif // !CALLGRAPH_FUNDEC_GRAPH_HXX
