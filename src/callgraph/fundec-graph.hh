...
namespace callgraph
{
  ...
  using fundecgraph_vertex_iter_type = boost::graph_traits<FundecGraph>::vertex_iterator;
  /// Iterator on the edges of a FundecGraph.
  using fundecgraph_edge_iter_type = boost::graph_traits<FundecGraph>::edge_iterator;
  /// Iterator on the neighborhood of a vertex of a FundecGraph.
  using fundecgraph_neighb_iter_type = boost::graph_traits<FundecGraph>::adjacency_iterator;
