...
RUN pacman -Syu --noconfirm clang gtest autoconf automake autoconf-archive boost gcc libtool zsh dash bash flex bison m4 make coreutils
...
COPY . /project
RUN chown -R $(id -un):$(id -gn) /project
