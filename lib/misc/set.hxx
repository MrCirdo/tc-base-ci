...
namespace misc
{
  ...
  inline set<K, C, A>::set(Iter first, Iter last)
  {
  ...
  template <class K, class C, class A>
  inline set<K, C, A>::set(const std::vector<K> v)
  {
    for (const K& x : v)
      this->insert(x);
  }
  ...
  template <class K, class C, class A>
  inline bool set<K, C, A>::has(const K& k) const
  {
  ...
  template <class K, class C, class A>
  inline set<K, C, A> set<K, C, A>::operator+(const K& data) const
  {
  ...
  /* \brief Insert \a data in \a this.
      \a data must not yet be part of \a this. */
  template <class K, class C, class A>
  inline set<K, C, A>& set<K, C, A>::operator+=(const K& data)
  {
    precondition(!(data % *this));
    this->insert(data);
    return *this;
  ...
  template <class K, class C, class A>
  inline set<K, C, A> set<K, C, A>::operator+(const set<K, C, A>& s) const
  {
  ...
  template <class K, class C, class A>
  inline set<K, C, A>& set<K, C, A>::operator+=(const set<K, C, A>& s)
  {
    return *this = *this + s;
  }
  ...
  template <class K, class C, class A>
  inline set<K, C, A> set_difference(const set<K, C, A>& s1,
                                     const set<K, C, A>& s2)
  {
    set<K, C, A> res;
  ...
  template <class K, class C, class A>
  inline set<K, C, A> set_intersection(const set<K, C, A>& s1,
                                       const set<K, C, A>& s2)
  {
    set<K, C, A> res;
  ...
  template <class K, class C, class A>
  inline set<K, C, A> set_union(const set<K, C, A>& s1, const set<K, C, A>& s2)
  {
    set<K, C, A> res;
  ...
  template <class K, class C, class A>
  inline std::ostream& operator<<(std::ostream& ostr, const set<K, C, A>& s)
  {
